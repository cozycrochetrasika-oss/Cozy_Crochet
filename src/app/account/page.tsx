...
export default function AccountPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-8">
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-white border border-pink-100 shadow-sm flex flex-col sm:flex-row items-center gap-6">
        <div className="w-20 h-20 rounded-full bg-pink-50 border border-pink-100 flex items-center justify-center text-pink-600 font-display font-bold text-2xl shadow-xs">
          {initials}
        </div>
        <div className="space-y-1 text-center sm:text-left flex-grow">
          ...
          <span className="inline-block text-[10px] uppercase font-semibold bg-pink-50 text-pink-700 border border-pink-100 px-2.5 py-0.5 rounded-full mt-1">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {role === 'admin' && (
            <Link
              href="/admin"
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-pink-600 hover:bg-pink-700 text-white text-xs font-semibold transition-colors shadow-xs"
            >
          ...
          {isAuthenticated && (
            <button
              type="button"
              onClick={logout}
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-pink-50 hover:bg-pink-100 text-text-secondary hover:text-ink text-xs font-semibold transition-colors border border-pink-100"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <Link
          href="/orders"
          className="p-6 rounded-2xl bg-white border border-pink-100 hover:border-pink-300 transition-all shadow-sm space-y-2 group"
        >
          <Package className="w-6 h-6 text-pink-600 group-hover:scale-110 transition-transform" />
        ...
        <Link
          ...
          className="p-6 rounded-2xl bg-white border border-pink-100 hover:border-pink-300 transition-all shadow-sm space-y-2 group"
        >
          <KeyRound className="w-6 h-6 text-pink-600 group-hover:scale-110 transition-transform" />
        ...
        <div className="p-6 rounded-2xl bg-white border border-pink-100 space-y-2">
