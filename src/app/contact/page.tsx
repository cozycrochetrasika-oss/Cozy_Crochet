          ...
          <div className="p-6 rounded-3xl bg-white border border-blue-100 shadow-sm space-y-6">
            ...
            <div className="space-y-3.5 text-xs">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-3.5 p-3.5 rounded-2xl bg-blue-50/50 hover:bg-blue-100/70 border border-blue-100/80 transition-colors"
              >
            ...
            <div className="pt-2 border-t border-blue-100 flex items-center gap-2 text-xs text-text-secondary">
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl border border-blue-200 bg-white text-sm outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 text-ink"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm shadow-sm transition-all flex items-center justify-center gap-2"
                >
